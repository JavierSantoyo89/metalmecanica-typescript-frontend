  ...
  return (
    <>
      {props.buttonActionType == "Download" ? (
        <>
          <button className={styleDownload.Btn} style={{ height: `${props.heightIcon}px`, width: `${props.withIcon}px` }}>
            <svg
        
              
              viewBox="0 0 384 512"
              className={styleDownload.svgIcon}
            >
      ...
      {props.buttonActionType == "Edit" ? (
        <>
          <button className={buttonEdit.editBtn} style={{ height: `${props.heightIcon}px`, width: `${props.withIcon}px` }}>
            <svg
              height="1em"
      ...
      {props.buttonActionType == "Delete" ? (
        <>
          <button
            ...
            style={{ height: `${props.heightIcon}px`, width: `${props.withIcon}px` }}>
